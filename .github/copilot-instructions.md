...
Observed meshes (from GLB inspection and runtime logging)
- Group: Sketchfab_Scene
- Object3D chain: Sketchfab_model, root, GLTF_SceneRootNode, RootNode0_0, skeletal3_6, GLTF_created_0
...
Reference: generated JSX and GLB inspection show the root joint `GLTF_created_0_rootJoint` and skinned meshes listed above. Prefer rotating the root joint or aligning the `GLTF_created_0_rootJoint` world position to the desired anchor before applying cinematic rotations.